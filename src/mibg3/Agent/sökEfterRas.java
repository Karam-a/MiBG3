...
public class sökEfterRas extends javax.swing.JFrame {
    ...
    private void hämtaData(){
        try{
        //ArrayList<String> alienIDB;
        //ArrayList<String> alienIDW;
        //ArrayList<String> alienIDS;
        //alienIDB = mibdb.fetchColumn("SELECT Alien_ID FROM Boglodite");
        //alienIDW = mibdb.fetchColumn("SELECT Alien_ID FROM Worm");
        //alienIDS = mibdb.fetchColumn("SELECT Alien_ID FROM Squid");
